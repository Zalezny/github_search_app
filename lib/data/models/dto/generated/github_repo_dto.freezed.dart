...
@override
String toString() {
  return 'GithubRepoDto(id: $id, name: $name, fullName: $fullName, description: $description, htmlUrl: $htmlUrl, stargazersCount: $stargazersCount, forksCount: $forksCount, language: $language, owner: $owner, updatedAt: $updatedAt)';
}
