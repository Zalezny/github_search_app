...
class _GithubApiService implements GithubApiService {
  ...
  @override
  Future<GithubRepositoryDto> getRepositoryDetails(
    String owner,
    String repo,
  ) async {
    final _extra = <String, dynamic>{};
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GithubRepositoryDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/repos/${owner}/${repo}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GithubRepositoryDto _value;
    try {
      _value = GithubRepositoryDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
